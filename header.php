...
<div id="page" class="site">
	...
	<div id=cookieconsent>By using this website you consent to the Terms of Use and the privacy policy, including the use of third party cookies. <a href='<?php echo get_stylesheet_directory_uri() . "/inc/terms.html";?>'>Learn more here.</a> <button onclick="cookieConsentClose()">Close</button></div>
